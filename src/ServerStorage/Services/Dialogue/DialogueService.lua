...
function DialogueService:LookAtPlayer(NPC : Model, PLR : Player)
    ...
    return LookAnim:Play()
end

function DialogueService:PopUp(LocalUi : BillboardGui, Value : boolean): any?
   --LocalUi.Enabled = Value
